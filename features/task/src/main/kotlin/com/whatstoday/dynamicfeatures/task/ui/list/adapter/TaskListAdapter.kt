...
import com.whatstoday.commons.ui.base.BasePagedListAdapter
import com.whatstoday.dynamicfeatures.task.ui.list.TaskListViewModel
import com.whatstoday.dynamicfeatures.task.ui.list.adapter.holders.TaskViewHolder
import com.whatstoday.dynamicfeatures.task.ui.list.adapter.holders.ErrorViewHolder
import com.whatstoday.dynamicfeatures.task.ui.list.adapter.holders.LoadingViewHolder
...
class TaskListAdapter @Inject constructor(
    ...
    private var state: TaskListAdapterState = TaskListAdapterState.Added
    ...
    override fun onCreateViewHolder(
        ...
        when (ItemView.valueOf(viewType)) {
            ItemView.CHARACTER -> TaskViewHolder(inflater)
     ...
     */
    fun submitState(newState: TaskListAdapterState) {
        val oldState = state
        state = newState
